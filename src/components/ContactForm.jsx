    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] p-4">
      <div className="w-full max-w-5xl flex flex-col md:flex-row bg-white/5 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/10">
        ...
        <form
          ...
          className="flex-1 p-6 sm:p-8 md:p-10 space-y-5 text-white"
        >
          ...
          <button
            type="submit"
            className="mt-6 bg-gradient-to-br from-[#ae7de8] to-[#947be4] text-black px-6 py-3 rounded-md font-semibold hover:bg-gray-100 transition text-xl cursor-pointer w-full sm:w-auto"
          >
            Send Message
          </button>
        </form>

        {/* Right Panel (Always visible, stacks below form on small screens) */}
        <div
          ref={panelRef}
          className="flex flex-1 flex-col items-center justify-center text-center p-6 sm:p-8 md:p-10 text-white bg-gradient-to-b from-green-500/20 to-blue-500/30"
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Join Our Community</h2>
          <p className="text-white/80 text-sm sm:text-base">Create Your High-Level Cloud Network Service!</p>
        </div>
      </div>
    </section>
